...
class SettingsList extends Component {
  ...
  shouldComponentUpdate(newProps, newState) {
    return this.props.newGrowPlant !== newProps.newGrowPlant || this.props.climates !== newProps.climates || this.state.displaySettings !== newState.displaySettings
  }
...
render() {
    return (
      <div className="directions left">
        <ListGroupContainer
          items={this.state.displaySettings} />
      </div>
    )
  }
